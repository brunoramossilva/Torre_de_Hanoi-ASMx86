section .data ; Inicializando a seção que possui dados já definidos (como se fossem "constantes")
    prompt db "Digite a quantidade de discos com que você deseja jogar: ", 0 ; Define a mensagem de entrada do prompt. O 0 no final serve para delimitar onde a string finalizará (um "marco" para o programa saber que é para finalizar ali)
    ...
    output db "Quantidade de discos escolhida para jogar: ", 0 ; Define a mensagem de saída utilizando a mesma lógica da mensagem de entrada
